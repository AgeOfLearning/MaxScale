...
static char	*regex_replace(char *sql, pcre2_code *re, pcre2_match_data *study, char *replace);
 ...
 */
static char *
regex_replace(char *sql, pcre2_code *re, pcre2_match_data *match_data, char *replace)
{
    char *result = NULL;
    size_t result_size;
    int rc;
